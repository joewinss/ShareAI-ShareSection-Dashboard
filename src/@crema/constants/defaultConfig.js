...
export const appThemeFont = {
    family: ['Assistant', 'sans-serif'].join(','),
    weight: {
        light: Fonts.LIGHT,
...
const defaultConfig = {
    ...
    themeMode: process.env.NEXT_PUBLIC_THEME_MODE,
    footerType: FooterType.FLUID,
    navStyle: process.env.NEXT_PUBLIC_NAV_STYLE,
    layoutType: process.env.NEXT_PUBLIC_LAYOUT_TYPE,
    footer: false,
    rtlLocale: ['ar'],
};
