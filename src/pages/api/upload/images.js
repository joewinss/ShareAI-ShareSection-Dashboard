...
export default async function images(data = {}) {
    ...
    const session = getSessionType("POST", `${client.uri.apiLink}api/upload/images`);
    ...
    try {
        ...
        const response = await axios.post(`${client.uri.apiLink}api/upload/images`, formData, { headers });
